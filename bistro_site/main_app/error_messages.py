...
incorrect_product_weight = 'Ошибка! Вес продукта питания представляет из себя целое число от 1 до 1 000!'
#product_calories
...
incorrect_product_calories = 'Ошибка! Калорийность продукта питания представляет из себя целое число от 30 до 10 000!'
#product_price
...
incorrect_recipe_name = 'Ошибка! Название рецепта блюда состоит только из русских символов. Первое слово должно начинаться с большой буквы, а остальные с маленькой!'
#recipe_time
...
#daily_report_date
incorrect_date_format = 'Ошибка! Вы ввели некорректный формат даты. Корректный формат - дд.мм.гггг'
...
#daily_report_count
little_dailyreport_count = 'Ошибка! Минимальное количество проданных блюд от 1!'
...
little_dishcomposition_count = 'Ошибка! Количество продуктов в составе блюда должно быть от 1!'
